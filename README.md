...
- Установить образ убунту [link](https://drive.google.com/drive/u/1/folders/1yaOkhyw99g63MnO0nDXtLBTjpZcPOfGz) и поместите рядом со скриптом
- Запустите скрипт judge0_script.sh. Затем скопируйте ip адрес, который скприпт выдаст (либо https://ce.judge0.com если возникли проблемы с запуском виртуальной машины)
- Запуститите докер контейнер, который лежит рядом judge0_script.sh 
